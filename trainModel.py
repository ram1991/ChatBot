...
embedding_layer = Embedding(input_dim = nb_words, output_dim = 300, trainable = True)
embedding_layer.build((None,))
embedding_layer.set_weights([embedding_matrix])

encoder_inputs = Input(shape = (None,))
encoder_input_embeddings = embedding_layer(encoder_inputs)
encoder_lstm_layer =LSTM(300, return_state = True)
...
decoder_lstm_layer = LSTM(300, return_state = True, return_sequences = True)
